...
public class JPQLTest {
	...
	@Test
	public void findAll_jpql_basic() { // basic JPQL Queries
	...
	@Test
	public void findAll_jpql_typed() {// basic JPQL typed Queries where the result returned is in List<course> type
